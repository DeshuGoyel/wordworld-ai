          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            Row(children: [
              GestureDetector(onTap: () => context.pop(),
                child: Container(width: 40, height: 40, decoration: BoxDecoration(color: AppColors.codingWorld.withOpacity(0.1), borderRadius: BorderRadius.circular(12)),
            ...
            Container(
              ...
              decoration: BoxDecoration(
                gradient: LinearGradient(colors: [AppColors.codingWorld, AppColors.codingWorld.withOpacity(0.7)]),
        ...
        child: Column(children: [
          Row(children: [
            GestureDetector(onTap: widget.onBack,
              child: Container(width: 40, height: 40, decoration: BoxDecoration(color: const Color(0xFF00CEC9).withOpacity(0.1), borderRadius: BorderRadius.circular(12)),
            ...
            for (int i = 0; i < _userOrder.length; i++)
              GestureDetector(
                ...
                child: Container(padding: const EdgeInsets.symmetric(horizontal: 14, vertical: 8),
                  decoration: BoxDecoration(
                    color: _checked ? (_userOrder[i] == correctSteps[i] ? AppColors.success.withOpacity(0.1) : AppColors.error.withOpacity(0.1)) : const Color(0xFF00CEC9).withOpacity(0.1),
        ...
        child: Column(children: [
          ...
          ClipRRect(borderRadius: BorderRadius.circular(8),
            child: LinearProgressIndicator(value: (q + 1) / total, minHeight: 8,
              backgroundColor: AppColors.codingWorld.withOpacity(0.1), valueColor: const AlwaysStoppedAnimation(AppColors.codingWorld))),
          const SizedBox(height: 20),
